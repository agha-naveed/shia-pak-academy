  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 antialiased">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[220px_1fr_220px]">
            ...
            <div className="relative overflow-hidden rounded-xl">
              ...
              <span className="absolute left-3 top-3 z-10 rounded-md bg-emerald-800/90 px-2.5 py-1 text-[11px] font-semibold text-white backdrop-blur-sm">
                Online on WhatsApp
              </span>
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h1 className="mb-1 text-3xl font-bold text-gray-900">Tafseer of Quran</h1>
                <p className="mb-3 text-base font-medium text-emerald-700">
                ...
                {/* Meta pills */}
                <div className="mb-6 flex flex-wrap gap-5 text-xs text-gray-600">
              ...
              <div>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-800 py-3.5 text-sm font-semibold text-white shadow transition hover:bg-emerald-900 sm:w-auto sm:px-10"
                >
            ...
            {BENEFITS.map((b) => (
              <div key={b.title} className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-[11px] leading-relaxed text-gray-500">{b.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14">
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-5 flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-gray-900">About the Course</h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_280px]">
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-5">
              <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-gray-200">
                <span className="text-lg font-bold leading-none text-gray-500">"</span>
              </div>
              <p className="text-sm leading-relaxed text-gray-700 italic">
                The best among you are those who learn the Quran and teach it.
              </p>
              <p className="mt-3 text-xs text-gray-500">— Prophet Muhammad (ﷺ)</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
            {CURRICULUM.map((mod, i) => (
              <div
                key={mod.title}
                className="flex w-52 flex-shrink-0 flex-col rounded-xl border border-gray-200 bg-white p-4"
              >
                <p className="mb-3 text-sm font-bold text-gray-900">{mod.title}</p>
                <ul className="mb-4 flex-1 space-y-2">
                  {mod.items.map((item) => (
                    <li key={item} className="flex items-start gap-1.5 text-xs text-gray-600">
                      <span className="mt-1 block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-600" />
                      {item}
                    </li>
                  ))}
                </ul>
                <div className="mt-auto border-t border-gray-100 pt-3 text-xs font-medium text-gray-500">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {LEARN_ITEMS.map((item) => (
              ...
              >
                <item.icon className="mb-3 h-6 w-6 text-gray-400" strokeWidth={1.5} />
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14">
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-8 flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-gray-900">How It Works (On WhatsApp)</h2>
          </div>

          <div className="relative grid grid-cols-2 gap-6 lg:grid-cols-4">
            {/* Connecting line — desktop */}
            <div
              className="pointer-events-none absolute left-[12.5%] right-[12.5%] top-5 hidden h-px border-t-2 border-dashed border-gray-200 lg:block"
              aria-hidden
            />

            {HOW_STEPS.map((step) => (
              <div key={step.n} className="flex flex-col items-center text-center">
                <div className="relative z-10 mb-4 flex h-11 w-11 items-center justify-center rounded-full bg-emerald-700 text-sm font-bold text-white shadow">
                  {step.n}
                </div>
                <p className="mb-1.5 text-sm font-bold text-gray-900">{step.title}</p>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14">
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-gray-900">Who This Course Is For</h2>
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-16">
        <div className="flex flex-col items-center justify-between gap-6 rounded-2xl bg-gray-100 px-6 py-7 sm:flex-row">
          <div className="flex items-center gap-4">
            {/* WhatsApp circle icon */}
            <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full bg-emerald-700">
              <MessageCircle className="h-7 w-7 text-white" />
            </div>
            <div>
              <p className="text-base font-bold text-gray-900">Have Questions?</p>
              <p className="text-sm text-gray-500">We&apos;re here to help you start your learning journey.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-1 sm:items-end">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 rounded-xl bg-emerald-800 px-6 py-3 text-sm font-semibold text-white shadow transition hover:bg-emerald-900"
            >

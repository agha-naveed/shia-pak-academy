...
import { ZIYARAT_E_WARISA } from "../ZIYARAT";


// ─── DATA ─────────────────────────────────────────────────────────────────────


export default function ZiyaratWarisaPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#030102] transition-colors duration-300">
      ...
      <audio ref={audioRef} controls className="hidden" preload="none">
        <source src={`/audio/ziyarat-e-warisa.mp3`} />
      </audio>
      ...
      <section className="bg-emerald-950 py-12 text-white">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <h1 className="text-3xl font-bold sm:text-4xl lg:text-5xl">Ziyarat e Warisa</h1>
        </div>
      </section>
      ...
      <main className="mx-auto max-w-4xl px-4 py-10">
        {ZIYARAT_E_WARISA.map((segment:any, index:number) => {

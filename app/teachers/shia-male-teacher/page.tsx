      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0A1A0F] via-[#0D1F14] to-[#061008]">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center">
            ...
            {/* Right — Generic Highlight Card */}
            <div className="hidden lg:block">
              <div className="relative ml-auto max-w-sm overflow-hidden rounded-2xl border border-emerald-900/40 bg-white/5 p-8 backdrop-blur-sm ring-1 ring-emerald-800/20">
                {/* Glow */}
                <div className="pointer-events-none absolute -inset-1 rounded-2xl bg-emerald-500/5" />

                <div className="mb-6 flex h-14 w-14">
                  <Image src={logo} alt="Shia Quran Pak Academy Logo" width={200} height={200} />
                </div>
                <h3 className="mb-2 text-xl font-bold text-white">Expert Male Scholars</h3>
                <p className="mb-6 text-sm leading-relaxed text-gray-400">
                  Our male faculty consists of highly trained individuals, from Hawza graduates to specialized Quranic Qaris.
                </p>

                <div className="space-y-4">
                  {[
                    "One-on-one personalized attention",
                    "Deep knowledge of Shia Fiqh & Aqaid",
                    "Patient teaching style for all ages",
